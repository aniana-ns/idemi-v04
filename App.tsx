...
// Combined Featured Courses Page
const FeaturedCourses = lazy(() => import('./pages/FeaturedCourses'));
const AllIDEMICourses = lazy(() => import('./pages/AllIDEMICourses'));
...
const UdyamCertificate = lazy(() => import('./pages/UdyamCertificate'));
const GSTINCertificate = lazy(() => import('./pages/GSTINCertificate'));
          ...
          <Layout>
            <Suspense fallback={<SkeletonPage />}>
              <Routes>
                ...
                <Route path="/library" element={<Navigate to="/services/library" replace />} />
                ...
                <Route path="/udyam-registration" element={<UdyamCertificate />} />
                <Route path="/gstin-certificate" element={<GSTINCertificate />} />
                ...
                <Route path="/training/featured-courses" element={<FeaturedCourses />} />
                <Route path="/training/all-courses" element={<AllIDEMICourses />} />
                
                {/* Legacy Redirects to consolidated page with hash for specific focus */}
                <Route path="/courses/mechanical-courses/ansys" element={<Navigate to="/training/featured-courses#ansys" replace />} />
                <Route path="/courses/mechanical-courses/unigraphics" element={<Navigate to="/training/featured-courses#unigraphics" replace />} />
                <Route path="/courses/mechanical-courses/autocad" element={<Navigate to="/training/featured-courses#autocad" replace />} />
                <Route path="/courses/animation/arvr" element={<Navigate to="/training/featured-courses#arvr" replace />} />
                <Route path="/uxui" element={<Navigate to="/training/featured-courses#uxui" replace />} />
