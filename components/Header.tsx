    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            label: "International Associations",
            path: "/international-associations",
          },
    ...
    children: [
      {
        ...
        children: [
          ...
          { label: "Long Term", path: "/training/post-graduate-post-diploma" },
          {
      ...
      },
      {
        ...
        children: [
          ...
          {
            label: "Rapid Prototyping in Plastic",
            path: "/services/rapid-prototyping-in-plastic",
          },
          {
            label: "Tool Room Infrastructure",
            path: "/services/tool-room-infrastructure",
          },
          {
            label: "Steam Boiler / LOCA Test Facility",
      ...
      },
      {
        ...
        children: [
          ...
          {
            label: "Electro-Technical Calibration",
          ...
          {
            label: "Mass and Volume Calibration",
          ...
          {
            label: "Fluid Flow Calibration",
            path: "/services/calibration/fluid-flow",
          },
          {
            label: "Laboratory Excellence Award",
    ...
    children: [
      { label: "Training Overview", path: "/training" },
      {
        ...
        children: [
          ...
          {
            label: "Admission Schedule 2025",
            path: "/training/aicte/schedule",
          },
        ],
      },
      { label: "Full Course Catalog", path: "/training/all-courses" },
      ...
      { label: "Feature Courses", path: "/training/featured-courses" },
      {
        label: "Jobs & Reports",
        children: [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        path: "https://swachhbharat.mygov.in/",
        external: true,
      },
      {
        ...
        children: [
          {
            label: "Calibration",
            path: "https://nablwp.qci.org.in/CertificateScopenew?x=yXVyaj7QFLkbCMh+XmlfUQ==&p=1&src=P&LS=balhcraes",
            external: true,
          },
          {
            label: "Testing",
            path: "http://www.nabl-india.org/nabl/index.php?c=search&m=searchlabcertificate&cno=149",
            external: true,
          },
        ],
      },
...
const NavItem: React.FC<NavItemProps> = ({ item, depth = 0 }) => {
    ...
    return (
      ...
      >
        {item.path && !hasChildren ? (
          <Link
            to={item.path}
            className={topLevelBaseClass}
            aria-current={active ? "page" : undefined}
            role="menuitem"
          >
            {item.label}
            <span
              className={`absolute bottom-0 left-2 right-2 h-0.5 bg-primary dark:bg-blue-400 transition-all duration-300 ease-out ${active ? "w-[calc(100%-16px)]" : "w-0 group-hover:w-[calc(100%-16px)]"}`}
            ></span>
          </Link>
        ) : (
          <button
          ...
          >
            ...
            />
            <span
              className={`absolute bottom-0 left-2 right-2 h-0.5 bg-primary dark:bg-blue-400 transition-all duration-300 ease-out ${isOpen || active ? "w-[calc(100%-16px)]" : "w-0 group-hover:w-[calc(100%-16px)]"}`}
            ></span>
          </button>
        )}
        ...
        {hasChildren &&
          (isMega ? (
            <div
              id={uniqueId}
              className={`absolute top-full left-0 w-full bg-white dark:bg-gray-900 shadow-xl border-t border-gray-200 dark:border-gray-800 transition-all duration-300 z-50 ${isOpen ? "opacity-100 visible translate-y-0" : "opacity-0 invisible -translate-y-2 pointer-events-none"}`}
            >
  ...
  const dropdownItemClass =
    "block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-blue-50 dark:hover:bg-gray-700 hover:text-primary dark:hover:text-blue-400 transition-all border-l-2 border-transparent hover:border-primary w-full text-left outline-none focus:bg-blue-50 dark:focus:bg-gray-700 focus:border-primary";
  ...
  if (hasChildren) {
    return (
      <div className="w-full">
        ...
        >
          <span
            className={`flex-grow ${level === 0 ? "text-base font-medium text-gray-800 dark:text-gray-100" : "text-sm text-gray-700 dark:text-gray-300"} hover:text-primary dark:hover:text-blue-400`}
          >
            {item.label}
          </span>
          <ChevronDown
        ...
        <div
          id={uniqueId}
          className={`overflow-hidden transition-all duration-300 ease-in-out ${isOpen ? "max-h-[1000px] opacity-100" : "max-h-0 opacity-0 invisible"}`}
        >
          <div
            className={`${level === 0 ? "bg-gray-50 dark:bg-gray-800 pl-4 py-2 rounded-lg mt-1" : "pl-4 border-l border-gray-200 dark:border-gray-700 ml-2"}`}
          >
            {item.children!.map((child, idx) => (
              <MobileNavItem
                key={idx}
...
const Header: React.FC = () => {
            ...
            new (window as any).google.translate.TranslateElement(
              {
                pageLanguage: "en",
                includedLanguages:
                  "en,hi,mr,gu,bn,kn,ta,te,ml,pa,or,ur,as,sa,mai,kok,sd",
                autoDisplay: false,
              },
  ...
  const achievements = [
    {
      label:
        "Winner: Prof. S.K. Joshi Laboratory Excellence Award (Gold Category)",
      icon: <Trophy size={14} className="text-amber-500" />,
      path: "/services/calibration/laboratory-excellence-award",
    },
    {
      label: "Critical Component Supplier for ISRO's Chandrayaan-3 Mission",
      icon: <Rocket size={14} className="text-blue-400" />,
      path: "/past_performance",
    },
    {
      label: "Premier NABL Accredited Calibration Laboratory in Asia",
      icon: <ShieldCheck size={14} className="text-green-500" />,
      path: "/NABL-Certificate",
    },
    {
      label: "Over 50 Years of Excellence in Instrumentation & Metrology",
      icon: <History size={14} className="text-secondary" />,
      path: "/about",
    },
    {
      label:
        "Empowering National Defense and Aerospace Sectors (AS9100 Certified)",
      icon: <Award size={14} className="text-purple-400" />,
      path: "/ISO-AS9100-2016",
    },
  ];
  ...
  return (
    <header className="w-full z-[1000] font-sans sticky top-0 shadow-lg">
      <div className="w-full bg-white/95 dark:bg-gray-900/95 backdrop-blur-md transition-colors duration-200">
        <div
          className="bg-[#1b3270] text-white py-1 text-[10px] sm:text-xs relative z-[102]"
          role="complementary"
          aria-label="Official Government Label"
        >
        ...
        <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm z-[101] relative border-b border-gray-200 dark:border-gray-800">
          <div className="container mx-auto px-4 py-2 sm:py-3 lg:py-4">
            ...
            <div className="hidden xl:flex items-center justify-between gap-4 md:gap-6 lg:gap-8">
              <Link
                to="/"
                className="shrink-0 group focus:outline-none notranslate"
                aria-label="IDEMI Left Logo - Go to home"
              >
                <img
              ...
              <Link
                to="/"
                className="flex-1 text-center px-4 hover:opacity-90 transition-opacity focus:outline-none block notranslate"
                aria-label="IDEMI - Institute for Design of Electrical Measuring Instruments"
              >
              ...
              <Link
                to="/"
                className="shrink-0 group focus:outline-none notranslate"
                aria-label="IDEMI Right Logo - Go to home"
              >
                <img
            ...
            <div className="xl:hidden flex justify-between items-center">
              <Link
                to="/"
                className="flex items-center gap-3 focus:outline-none group notranslate"
                aria-label="IDEMI Home"
              >
                <img
                  src="https://idemi.org/assets/images/LOGO-27042023.png"
                  alt="IDEMI Left Logo"
        ...
        <div className="hidden xl:block border-b border-gray-200 dark:border-gray-800 bg-white/95 dark:bg-gray-900/95 backdrop-blur z-[100] relative shadow-sm">
          <div className="container mx-auto px-4">
            ...
            >
              <ul
                className="flex flex-wrap gap-2 xl:gap-4 items-center"
                role="menubar"
              >
        ...
        <div className="bg-gray-100 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 transition-colors duration-200 relative z-[98]">
          ...
          >
            ...
            <ChevronDown
              size={14}
              className={`transition-transform duration-300 ${isCertInfoOpen ? "rotate-180" : ""}`}
              aria-hidden="true"
            />
          </button>

          <div
            id="certifications-bar"
            className={`${isCertInfoOpen ? "flex py-1.5 opacity-100 visible" : "hidden"} md:flex container mx-auto px-4 flex-wrap justify-center gap-x-6 gap-y-1 text-[8px] md:text-[12px] text-gray-600 dark:text-gray-400 font-bold py-1.5 transition-all duration-300`}
          >
            <Link
              to="/ISO-9001-2015-Certificate"
            ...
            <a
              ...
              className="hover:text-primary dark:hover:text-blue-400 transition-colors"
            >
              GeM Seller ID: WHVV210002896286
            </a>
            <span
              className="hidden sm:inline text-gray-300 dark:text-gray-600"
              aria-hidden="true"
            ...
            <Link
              to="/view-document?url=https://idemi.org/assets/uploads/Udyam%20Registration%20Certificate.pdf&title=Udyam Registration Certificate"
              className="hover:text-primary dark:hover:text-blue-400 transition-colors"
            >
              Udyam Registration No.: UDYAM-MH-18-0053036
            </Link>
            <span
              className="hidden sm:inline text-gray-300 dark:text-gray-600"
              aria-hidden="true"
            ...
            <Link
              to="/view-document?url=https://idemi.org/assets/uploads/IDEMI%20GSTIN%20Certificate.pdf&title=GSTIN Certificate"
              className="hover:text-primary dark:hover:text-blue-400 transition-colors"
            >
              GSTIN: 27AAAAI0012M1Z1
            </Link>
          </div>
        </div>
        ...
        <div
          className="bg-slate-900 dark:bg-black text-white h-9 flex overflow-hidden relative shadow-inner z-[97]"
          role="region"
          aria-label="Major Achievements Ticker"
        >
          <div className="bg-secondary text-white px-4 flex items-center gap-2 font-black text-[10px] uppercase shrink-0 z-20 relative shadow-xl skew-x-[-10deg] -ml-4 pl-8 border-r border-white/20">
            <div className="skew-x-[10deg] flex items-center gap-2">
              <Trophy
                ...
                aria-hidden="true"
              />
              <span className="hidden sm:inline tracking-[0.15em] whitespace-nowrap">
                Major Achievements
              </span>
            </div>
          </div>
          ...
          <div className="flex-grow flex items-center relative overflow-hidden group">
            <div className="animate-marquee whitespace-nowrap flex items-center gap-16 pl-6 group-hover:[animation-play-state:paused]">
              {achievements.concat(achievements).map((item, idx) => (
                ...
                >
                  {item.icon}
                  <span className="opacity-90 hover:opacity-100 transition-opacity text-slate-100 group-hover:text-amber-100">
                    {item.label}
                  </span>
                  <span
                    className="w-1.5 h-1.5 rounded-full bg-slate-700 mx-4"
                    aria-hidden="true"
                  ></span>
                </Link>
              ))}
        ...
        <div
          id="search-panel"
          className={`absolute top-full left-0 w-full bg-white/95 dark:bg-gray-955 backdrop-blur-md shadow-2xl border-t border-gray-200 dark:border-gray-800 transition-all duration-300 origin-top ${isSearchOpen ? "opacity-100 visible scale-y-100" : "opacity-0 invisible scale-y-0"} z-[99]`}
        >
                ...
                <div className="absolute top-full left-0 w-full mt-3 bg-white dark:bg-gray-900 rounded-[2rem] shadow-2xl border border-gray-100 dark:border-gray-800 overflow-hidden z-50 animate-scale-up origin-top">
                  ...
                  <ul role="listbox" aria-label="Search suggestions">
                      ...
                      <li key={index} role="option" aria-selected={false}>
                        ...
                        >
                          <div className="min-w-0">
                            <p className="font-bold text-gray-900 dark:text-white text-sm group-hover:text-primary dark:group-hover:text-blue-400">
                              {item.title}
                            </p>
                            <p className="text-[11px] text-gray-500 dark:text-gray-400 mt-0.5 truncate max-w-lg">
                              {item.desc}
                            </p>
                          </div>
                          <div className="flex items-center gap-3 shrink-0 ml-4">
                            <span className="text-[8px] font-black px-2 py-0.5 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400 uppercase tracking-wider border border-gray-200 dark:border-gray-700">
                              {item.type}
                            </span>
                            <ChevronRight
                              size={16}
                              className="text-gray-300 group-hover/item:text-primary dark:group-hover:text-blue-400 transition-colors"
                              aria-hidden="true"
                            />
                          </div>
                        </button>
                    ...
                    <li className="bg-gray-50/50 dark:bg-gray-800/50 p-4 text-center">
                      <button
                        type="submit"
                        className="text-xs text-primary dark:text-blue-400 font-black hover:underline uppercase tracking-widest flex items-center justify-center gap-2 mx-auto transition-transform hover:scale-105"
                      >
        ...
        <div
          id="mobile-menu"
          ref={mobileMenuRef}
          className={`xl:hidden absolute top-full left-0 w-full bg-white/95 dark:bg-gray-900/95 backdrop-blur-md border-t border-gray-200 dark:border-gray-800 shadow-2xl py-4 px-4 flex flex-col gap-2 z-[99999] max-h-[85vh] overflow-y-auto overscroll-contain transition-all duration-300 ease-in-out ${
            isMenuOpen
        ...
        >
          <div className="px-2 mb-4">
            <form
              onSubmit={handleSearch}
              className="relative flex items-center p-1 bg-gray-100 dark:bg-gray-800 rounded-full"
              role="search"
            >
              ...
              <button
                type="submit"
                className="absolute right-1 p-2 bg-primary text-white rounded-full shadow-lg active:scale-95"
          ...
          <div className="pt-6 pb-20">
            <button
              ...
              className="block w-full text-center bg-primary text-white py-3 rounded-lg font-bold shadow-lg hover:shadow-xl hover:bg-blue-800 transition-all"
            >
              Contact Us
            </button>
          </div>
