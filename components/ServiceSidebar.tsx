...
const SERVICE_MENU = [
  {
    ...
    path: '/training',
    items: [
      { label: '--- All Programs ---', path: '/training/all-courses', isHeader: true },
      ...
      { label: 'Admission Schedule', path: '/training/aicte/schedule' },
      ...
      { label: '--- Professional Workshops ---', path: '/training/professional-courses', isHeader: true },
      { label: 'Professional Workshops', path: '/training/professional-courses' },

      { label: '--- Featured Courses ---', path: '/training/featured-courses', isHeader: true },
      { label: 'Featured Technical Courses', path: '/training/featured-courses' },

      { label: '--- Jobs & Reports ---', path: '/training/job-openings', isHeader: true },
      ...
      { label: '--- SC/ST Beneficiaries ---', path: '/training/sc_st_beneficiaries', isHeader: true },
