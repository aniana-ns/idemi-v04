...
const CourseDomainBanner = () => (
  <div className="mb-6 overflow-hidden rounded-3xl bg-slate-900 text-white shadow-xl relative group reveal-on-scroll">
      ...
      <img
          ...
          alt="Advanced Technology Training"
      />
      <div className="relative z-20 p-6 md:p-10">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-amber-500 text-slate-900 rounded-full text-[10px] font-black uppercase tracking-widest mb-4 shadow-xl">
             <Zap size={14} fill="currentColor" /> Industry 4.0 Ready
          </div>
          ...
          <p className="text-blue-100/90 text-xs md:text-sm max-w-2xl leading-relaxed mb-6 font-medium">
              IDEMI empowers learners with world-class technical education in cutting-edge fields including <span className="text-amber-400 font-bold">Animation, AR/VR, AI & ML, Robotics, Electronics, IoT, PLC, Electrical Engineering, Fashion Design, and beyond</span>. Our comprehensive long-term programs are led by industry experts, delivering deep-tech hands-on knowledge and real-world insights—anytime, anywhere.
          </p>
...
const LongTermCourses: React.FC = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const filtered = allData.filter(c => 
          c.type.toLowerCase().includes('long term course') || 
          c.type.toLowerCase().includes('pg diploma') || 
          c.type.toLowerCase().includes('post diploma')
        );
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-950 min-h-screen transition-colors duration-200">
      <SEO seo={{ title: 'Long Term Technical Programs | IDEMI Mumbai', description: 'Advance your career with full-time long-term technical programs and PG diplomas in engineering and design.' }} path="/training/post-graduate-post-diploma" />
      ...
      <div className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 sticky top-[114px] xl:top-[124px] z-30 shadow-sm">
        <div className="container mx-auto px-4 py-3">
             ...
             <h1 className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white uppercase tracking-tight">Long Term Programs</h1>
        </div>
      </div>
             ...
             <div className="bg-white dark:bg-gray-800 p-5 md:p-6 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 reveal-on-scroll">
                ...
                <div className="space-y-4 mb-6 bg-gray-50 dark:bg-gray-900/50 p-4 rounded-2xl border border-gray-100 dark:border-gray-700">
                    <div className="relative mb-4">
                        ...
                        <input 
                            type="text" 
                            placeholder="Filter long term programs..." 
                            value={searchTerm}
                    ...
                    <div className="space-y-4">
                        {filteredCourses.length > 0 ? filteredCourses.map((course, idx) => {
                                    ...
                                    <div className="flex flex-col md:flex-row">
                                        ...
                                        <div className="flex-grow p-4 md:p-5 flex flex-col">
                                            <div className="flex items-center gap-2 mb-2">
                                                <span className="px-2 py-0.5 bg-primary text-white text-[9px] font-black uppercase rounded shadow-sm">NSQF Level {course.nsqf || 'Level'}</span>
                                                <span className="text-[9px] font-black text-secondary uppercase tracking-widest">{course.type}</span>
                                            </div>
                                            
                                            <h3 className="text-base font-bold text-gray-900 dark:text-white mb-2 group-hover:text-secondary transition-colors leading-tight">{course.name}</h3>
                                        ...
                                        <div className="p-4 animate-fade-in bg-slate-50 dark:bg-slate-900/50 border-t border-gray-100 dark:border-gray-700">
                                            <div className="bg-white dark:bg-gray-900 rounded-xl border-2 border-secondary/20 overflow-hidden shadow-xl">
                                                <div className="bg-secondary p-2 flex justify-between items-center text-white">
                                                    <span className="text-[10px] font-black uppercase tracking-widest flex items-center gap-1"><FileText size={12} /> Prospectus</span>
                            ...
                            <div className="py-12 text-center bg-gray-50 dark:bg-gray-900 rounded-3xl border-2 border-dashed border-gray-300">
                                <p className="text-gray-400 font-bold uppercase tracking-widest text-[10px]">No matching programs found</p>
                            </div>
                        )}
                    </div>
                )}
