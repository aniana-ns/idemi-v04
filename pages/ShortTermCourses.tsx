  ...
  <div className="mb-6 overflow-hidden rounded-3xl bg-slate-900 text-white shadow-xl relative group reveal-on-scroll">
      ...
      <div className="relative z-20 p-6 md:p-10">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-amber-500 text-slate-900 rounded-full text-[10px] font-black uppercase tracking-widest mb-4 shadow-xl">
             <Zap size={14} fill="currentColor" /> Skill Upgradation
          </div>
          ...
          <p className="text-blue-100/90 text-xs md:text-sm max-w-2xl leading-relaxed mb-6 font-medium">
              IDEMI empowers learners with world-class technical education in cutting-edge fields including <span className="text-amber-400 font-bold">Animation, AR/VR, AI & ML, Robotics, Electronics, IoT, PLC, Electrical Engineering, Fashion Design, and beyond</span>. Our specialized short-term certificate classes are led by industry experts, delivering rapid hands-on knowledge and real-world insights—anytime, anywhere.
          </p>
...
const ShortTermCourses: React.FC = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const filtered = allData.filter(c => 
          c.type.toLowerCase().includes('short term course')
        );
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-950 min-h-screen transition-colors duration-200">
      <SEO seo={{ title: 'Short Term Technical Courses | IDEMI Mumbai', description: 'Enhance your skills with IDEMI\'s short-term technical courses in CNC, PLC, CAD/CAM, and more.' }} path="/training/short-term-courses" />
      ...
      <div className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 sticky top-[114px] xl:top-[124px] z-30 shadow-sm">
        <div className="container mx-auto px-4 py-3">
             ...
             <h1 className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white uppercase tracking-tight">Short Term Programs</h1>
        </div>
      </div>
             ...
             <div className="bg-white dark:bg-gray-800 p-5 md:p-6 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 reveal-on-scroll">
                ...
                <div className="space-y-4 mb-6 bg-gray-50 dark:bg-gray-900/50 p-4 rounded-2xl border border-gray-100 dark:border-gray-700">
                    <div className="relative mb-4">
                        ...
                        <input 
                            type="text" 
                            placeholder="Filter short term courses..." 
                            value={searchTerm}
                ...
                {isLoading ? (
                    <div className="py-16 text-center flex flex-col items-center">
                        ...
                        <p className="text-gray-400 font-bold uppercase tracking-widest text-[10px]">Accessing Catalog...</p>
                    </div>
                ) : (
