...
import { ShieldCheck, Download, Calendar, Eye, X, FileText, ArrowLeft, CheckCircle, Building2 } from 'lucide-react';
...
const DATA = {
    ...
    description: 'This certificate confirms IDEMI as a registered Micro, Small, and Medium Enterprise under the Government of India, entitling the institution to support industrial growth and MSME development policies.',
    image: "https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&q=80",
    registrationNo: 'UDYAM-MH-18-0053036',
    pdfLink: "https://drive.google.com/file/d/1DFqLZLncdMAl-MFp5_pGOwpc6mpfKZLO/view?usp=drive_link",
    benefits: [
        "Eligibility for MSME-specific government schemes and subsidies.",
        "Priority in public procurement policies.",
        "Access to advanced technical support and technology clusters.",
        "Official recognition as a core constituent of the Indian MSME ecosystem."
    ]
};

const UdyamCertificate: React.FC = () => {
  useScrollAnimation();
             ...
             <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 reveal-on-scroll">
                ...
                <div className="flex flex-col md:flex-row gap-8 mb-12">
                    ...
                    <div className="md:w-1/2 flex flex-col">
                        <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Official Registration</h3>
                        ...
                        <div className="space-y-4 mb-8">
                            <div className="flex justify-between items-center py-3 border-b border-gray-100 dark:border-gray-700">
                                <span className="text-sm font-bold text-gray-500 uppercase tracking-wider flex items-center gap-2">
                                    <ShieldCheck size={16} className="text-green-500" /> Registration No.
                                </span>
                                <span className="font-mono font-bold text-gray-900 dark:text-white">{DATA.registrationNo}</span>
                            </div>
                        </div>
                ...
                <div className="mb-12">
                    <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-6 border-l-4 border-secondary pl-4">Key Objectives</h3>
